...
CREATE TABLE IF NOT EXISTS products (
    ...
    shortdescriptions VARCHAR(255) NULL,
    imageUrl VARCHAR(500) NULL,
    gallery JSON NULL,
    categoryId INT NULL,
...
CREATE TABLE IF NOT EXISTS translations (
    id INT AUTO_INCREMENT PRIMARY KEY,
    keyTrans VARCHAR(255) NOT NULL,
    languages VARCHAR(10) NOT NULL,
    val TEXT NOT NULL,
    context VARCHAR(100) NULL,
    createdAt DATETIME DEFAULT CURRENT_TIMESTAMP,
    updatedAt DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    UNIQUE KEY translation_key_language_unique (keyTrans, languages),
    INDEX idx_translations_key (keyTrans),
    INDEX idx_translations_language (languages)
);
...
-- Categories
INSERT INTO categories (name, slug, descriptions, isActive, sortOrder) VALUES
...
-- Products
INSERT INTO products (name, slug, price, descriptions, shortdescriptions, imageUrl, categoryId, category, stock, isActive, isFeatured, sku) VALUES 
...
-- Promo codes
INSERT INTO promo_codes (code, descriptions, discountType, discountValue, minPurchase, maxDiscount, usageLimit, isActive, validFrom, validUntil) VALUES
...
-- Translations (sample)
INSERT INTO translations (keyTrans, languages, val, context) VALUES
